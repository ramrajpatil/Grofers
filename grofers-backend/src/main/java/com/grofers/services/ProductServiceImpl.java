...
public class ProductServiceImpl implements IProductService {
	...
	public ProductResponseDto fetchAllProducts(Integer pageNumber, Integer pageSize, String sortBy, String sortDir) {
		...
		this.mapper.map(p, ProductDto.class))
	...
	public ProductDto fetchSingleProduct(Integer prodId) {
		...
		.orElseThrow(() -> 
		new NotFoundException("Product with id: "+prodId+" does not exist."));
	...
	public ProductDto updateProduct(ProductDto prodDto, Integer prodId) {
		...
		.orElseThrow(() -> 
		new NotFoundException("Category with id: "+prodDto.getCategory().getCategoryId()+" does not exist."));
		
		Supplier supplier = this.supRepo.findById(prodDto.getSupplier().getSupplierId())
		.orElseThrow(() -> 
		new NotFoundException("Supplier with id: "+prodDto.getSupplier().getSupplierId()+" does not exist."));
